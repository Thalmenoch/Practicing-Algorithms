...
x_treino, x_teste, y_treino, y_teste = train_test_split(matriz, matriz[:, -1], test_size=0.2, random_state=42, shuffle=True) #shuffle garante se a divisão vai ser aleatória
...
for train_indice, val_indice in kf.split(x_treino):
    ...
    y_fold_treino, y__fold_val = y_treino[train_indice], y_treino[val_indice]
