...
# Definindo os pesos e o viés para a porta NOR
weights = np.array([1, 1])  # Pesos positivos para negar os valores de entrada
bias = -0.5  # Viés
...
# Função para testar a porta NOR
def test_nor_gate():
    input_data = np.array([[0, 0], [0, 1], [1, 0], [1, 1]])

    print("Input 1\tInput 2\tNOR Output")
